...
<table width="100%" cellspacing="0" class="widefat">
  ...
  <tbody id="check_box_id">
    <tr>
      ...
      <td ><strong>程序目录：</strong><?php echo str_replace('templates\tadmin','',dirname( 'DADCCCDFFACFBA'  ));?></td>
    </tr>
    <tr>
