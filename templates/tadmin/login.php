    ...
    <form method="post" action="<?php echo site_url(CTL_FOLDER."login/check_login"); ?>" onsubmit="return Validator.Validate(this,2)">
      <table width="228" border="0" cellpadding="0" cellspacing="0" style="background:url({tpl_path}images/login-bg.gif) no-repeat">
        <tr>
          ...
          <td height="32"><input name="user_name" id="user_name" type="text" class="login-kk01" dataType="Require" msg="管理员账号必填" maxlength="30"/></td>
        </tr>
        <tr>
        ...
        <tr>
          <td width="79" height="32"></td>
          <td height="32"><input name="password" type="password" class="login-kk01" dataType="Require" msg="管理员密码必填" maxlength="30"/></td>
        </tr>
        <tr>
          <td height="7" colspan="2"></td>
        </tr>
      ...
      <table width="228" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
          <td height="58" align="left" valign="bottom"><div style="padding-left:53px">
              <input type="image" src="{tpl_path}images/bat-login.gif" title="登录" alt="登录" width="124" height="45" /></div></td>
        </tr>
      </table>
    </form>
  </div>
  <div id="bottom"><a href="<?php echo ROOT_PATH;?>">前台首页</a> | <a href="<?php echo site_url(CTL_FOLDER."login/find_password");?>">找回管理员密码</a> |   技术支持：</font><a href="http://bbs.soke5.com/" target="_blank" >搜客淘宝客</a></div>
</div>
</body>
</html>
